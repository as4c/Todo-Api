...
SECRET_KEY = 'django-insecure-is^b4=5lxn1v6-&9-vp238*(pj98+)vk-_d*(r5gzq80_p62c+'
...
INSTALLED_APPS  +=   MYAPPS     +   OTHER_APPS
...
CORS_ALLOWED_ORIGINS = [
    "http://as4c.pythonanywhere.com",
    "https://api.postman.com",
    "http://localhost:8000",
    "http://127.0.0.1:8000",
    "http://51.20.133.6:8000",
    "http://51.20.133.6:22"
